...
public class LeagueMemberTableHandler {
	...
	public static final String CREATE_SQL = "CREATE TABLE " + TABLE + "("
			...
			+ KEY_USER_ID + " " + TYPE_USER_ID + "," + FOREIGN_KEY_CONSTRAINT_LEAGUE + ","
			+ FOREIGN_KEY_CONSTRAINT_USER + ")";
	...
	public LeagueMember getLeagueMemberByID(int id) {
		Cursor cursor = db.query(TABLE, new String[] { KEY_ID,
				KEY_LEAGUE_ID, KEY_USER_ID }, KEY_ID + "=?",
	 ...
	 * @return
	 */
	public List<LeagueMember> getAllLeagueMembersByLeagueId(int leagueId) {
		List<LeagueMember> leagueMembersList = new ArrayList<LeagueMember>();
		Cursor cursor = db.query(TABLE, new String[] { KEY_ID,
					KEY_LEAGUE_ID, KEY_USER_ID }, KEY_LEAGUE_ID + "=?",
